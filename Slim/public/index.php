...
{      
    ...
    $mail->isHTML();
    $mail->Body=" Hola, $middleName $lastName su pedido de: $name, con cantidad de: $cartCount se encuentra con un estatus de: $estatus y con metodo de envio: $namee y su total a pagar es: $totalprecio  ";
...
print_r($results); */
 ...
 $sql = "INSERT INTO pedidoscomida (idcli, idtienda,idsuc,idpla, name, description, price, cartCount, categoryId,estatus)
 SELECT MAX(id), :idtienda, :idsuc, :idpla, :name, :description, :price, :cartCount, :categoryId, :estatus
 FROM pedidos " ;        
