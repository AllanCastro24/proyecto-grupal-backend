...
$app->get('/api/costos_programados/consultar', function(Request $request, Response $response){
    $consulta = "SELECT gastos_fijos_programados.id_gasto_fijo, tipo_gasto.nombre, gastos_fijos_programados.descripcion, gastos_fijos_programados.cantidad, gastos_fijos_programados.fecha, sucursales.Pseudonimo as nom_sucursal, gastos_fijos_programados.periodicidad, gastos_fijos_programados.status FROM gastos_fijos_programados
